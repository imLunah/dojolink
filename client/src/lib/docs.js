    ...
    sections: [
      ...
      },
      {
        ...
        blocks: [
          ...
          { list: [
            'On a computer, the bell is at the bottom of the sidebar, between your name and log out, or in the top bar if you use that layout. With the sidebar collapsed, a red dot on your picture means something is unread; select your picture, then **Notifications**.',
